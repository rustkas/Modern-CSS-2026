...
## 10.4 CSS Nesting и новая композиция селекторов

### Нативная вложенность

Нативная вложенность CSS изменила подход к написанию селекторов:
...
**1. Специфичность не увеличивается**
...
**Вложенность вместо архитектуры**
