...
**Style Queries** — заметно более свежая возможность, чем Size Queries: статус **Baseline Newly available** достигнут только в мае 2026 года. Для продакшн-проектов с широкой поддержкой браузеров стоит закладывать разумный fallback или проверку через `@supports`.
